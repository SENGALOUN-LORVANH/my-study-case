...
public class PanelCategory extends javax.swing.JPanel {
    ...
    private void autoID() {
        try {
            String sql = "SELECT SUBSTRING(MAX(category_id), 2, 4) FROM category";
    ...
    private void initComponents() {
        ...
        jPanel1.add(txtCategory_name, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 150, 310, -1));

        txtCategory_id.setEditable(false);
        txtCategory_id.setFont(new java.awt.Font("Lao_SomVang", 0, 14)); // NOI18N
        jPanel1.add(txtCategory_id, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 80, 310, -1));
    ...
    private void txtSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSearchKeyReleased
        try {
            String sql = "SELECT *FROM category WHERE concat(category_id, category_name) LIKE '%" + txtSearch.getText() + "%' ORDER BY category_id DESC";
            pst = conn.prepareStatement(sql);
            rs = pst.executeQuery();
